...
class Question(models.Model):
    ...
    description1 = models.TextField(max_length=1500, verbose_name='Описание вопроса 1', null=True)
    description2 = models.TextField(max_length=1500, verbose_name='Описание вопроса 2', blank=True, null=True)
